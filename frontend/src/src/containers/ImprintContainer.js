  ...
  render() {
    return (
      <div>
        <h2>Imprint</h2>
        <p>Ralf Westphal<br />
          Hans-Henny-Jahnn-Weg 44<br />
          22085 Hamburg
        </p>

        <p>
          Telefon: 0170-3200458<br />
          E-Mail: <a href="mailto:info@ralfw.de">info@ralfw.de</a>
        </p>

        <p>
          VAT-ID: DE198308154<br />
        </p>

        <p><a href="https://www.123recht.net/impressumsgenerator.asp">Imprint generated with Impressumsgenerator by 123recht.net - Rechtsberatung online.</a></p>
